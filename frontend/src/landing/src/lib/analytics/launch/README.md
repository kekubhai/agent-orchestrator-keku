...
- **`utm.ts`** — the canonical UTM link registry. One tagged inbound link per
  channel, all pointing at `orchestrator.inc`, so PostHog attributes each visit to
...
|---|---|---|
| Product Hunt | `product_hunt` | `https://orchestrator.inc/?utm_source=product_hunt&utm_medium=referral&utm_campaign=launch_day` |
| X / Twitter | `x` | `https://orchestrator.inc/?utm_source=x&utm_medium=social&utm_campaign=launch_day` |
| LinkedIn | `linkedin` | `https://orchestrator.inc/?utm_source=linkedin&utm_medium=social&utm_campaign=launch_day` |
| YouTube | `youtube` | `https://orchestrator.inc/?utm_source=youtube&utm_medium=social&utm_campaign=launch_day` (profile: `https://www.youtube.com/@itrytoohard`) |
| Discord | `discord` | `https://orchestrator.inc/?utm_source=discord&utm_medium=community&utm_campaign=launch_day` |
| GitHub | `github` | `https://orchestrator.inc/?utm_source=github&utm_medium=referral&utm_campaign=launch_day` |
| Instagram | `instagram` | `https://orchestrator.inc/?utm_source=instagram&utm_medium=social&utm_campaign=launch_day` |
